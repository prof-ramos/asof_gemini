...
const IconCard = ({ icon: Icon, title, description }: IconCardProps) => {
  return (
    <div className="bg-white p-8 hover:shadow-xl transition-shadow duration-300 border-t-4 border-transparent hover:border-accent group rounded-sm">
      <div className="w-6 h-6 bg-neutral rounded-full flex items-center justify-center mb-6 group-hover:bg-accent transition-colors duration-300">
